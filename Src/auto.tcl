...
proc auto_reset {} {
    global auto_execs auto_index auto_oldpath auto_dirs
...
#		are given auto_mkindex will look for *.tcl and *.in.
...
proc index {{dir "."} args} {
    ...
    append index "# This file is generated by the Lens \"index\" command\n"
